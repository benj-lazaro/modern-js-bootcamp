...
// Define debounce function that accepts a callback function & delay value as arguments
const debounce = (callbackFunction, delay = 1000) => {
  ...
  return (...arguments) => {
    ...
    // Execute callback function (fetchData()) with arguments after the last keypress
